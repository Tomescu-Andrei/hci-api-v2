...
Console.WriteLine(app.Services.GetRequiredService<ISecretsService>().AssistantInformations?.EndPoint);
Console.WriteLine(app.Services.GetRequiredService<ISecretsService>().AssistantInformations?.Key);
Console.WriteLine(app.Services.GetRequiredService<ISecretsService>().AssistantInformations?.Id);
